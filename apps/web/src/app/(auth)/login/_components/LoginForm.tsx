  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-[18px]">
      <div className="flex flex-col gap-1.5">
        <label htmlFor="email" className="text-[11px] font-light uppercase tracking-[0.08em] text-white/[0.35]">
          Email
        </label>
        <input
          id="email"
      ...
      <div className="flex flex-col gap-1.5">
        <label htmlFor="password" className="text-[11px] font-light uppercase tracking-[0.08em] text-white/[0.35]">
          Пароль
        </label>
        <input
          id="password"
          ...
          className="w-full rounded-[10px] border border-white/[0.08] bg-white/[0.03] px-4 py-3 text-sm font-light text-white outline-none transition-colors placeholder:text-white/[0.18] focus:border-amber/40 focus:bg-white/[0.05]"
        />
        <a href="#" className="mt-1 text-right text-[11px] font-light text-amber transition-opacity hover:opacity-70">
          Забыли пароль?
        </a>
      </div>
      ...
      <p className="mt-2 text-center text-[13px] font-extralight text-white/[0.3]">
        Нет аккаунта?{' '}
        <a href="/register" className="font-normal text-amber hover:underline">Регистрация</a>
      </p>
    </form>
  )
}
